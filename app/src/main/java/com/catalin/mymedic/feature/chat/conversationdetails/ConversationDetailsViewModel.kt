 ...
 * @since 6/20/2018
 */
class ConversationDetailsViewModel(private val conversationsRepository: ConversationsRepository, private val preferencesManager: SharedPreferencesManager) :
    ViewModel() {
...
//                        state.set(StateLayout.State.EMPTY)
    ...
    class Factory @Inject constructor(private val conversationsRepository: ConversationsRepository, private val preferencesManager: SharedPreferencesManager) :
        ViewModelProvider.Factory {
        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel?> create(modelClass: Class<T>) = ConversationDetailsViewModel(conversationsRepository, preferencesManager) as T
